 ...
 *     cdef float gap_start = - main_gap_start
 */
  __pyx_tuple__19 = PyTuple_Pack(14, __pyx_n_s_string1, __pyx_n_s_string2, __pyx_n_s_main_gap_start, __pyx_n_s_main_gap_continuation, __pyx_n_s_sim_func, __pyx_n_s_gap_start, __pyx_n_s_gap_continuation, __pyx_n_s_len_str1, __pyx_n_s_len_str2, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_m, __pyx_n_s_x, __pyx_n_s_y); if (unlikely(!__pyx_tuple__19)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__19);
  __Pyx_GIVEREF(__pyx_tuple__19);
  __pyx_codeobj__20 = (PyObject*)__Pyx_PyCode_New(5, 0, 14, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__19, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_py_stringmatching_similarity_mea_2, __pyx_n_s_affine, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__20)) __PYX_ERR(0, 8, __pyx_L1_error)
