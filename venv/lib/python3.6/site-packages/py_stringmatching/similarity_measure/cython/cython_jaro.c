 ...
 *         Args:
 */
  __pyx_tuple__26 = PyTuple_Pack(16, __pyx_n_s_string1, __pyx_n_s_string2, __pyx_n_s_len_str1, __pyx_n_s_len_str2, __pyx_n_s_max_len, __pyx_n_s_search_range, __pyx_n_s_flags_s1, __pyx_n_s_flags_s2, __pyx_n_s_common_chars, __pyx_n_s_low, __pyx_n_s_high, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_trans_count, __pyx_n_s_k, __pyx_n_s_score); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(2, 0, 16, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_py_stringmatching_similarity_mea_2, __pyx_n_s_jaro, 8, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 8, __pyx_L1_error)
